  ...
  useReveal(root, (scroller) => {
    ...
    gsap.fromTo(
      ...
      { xPercent: 4 },
      {
        xPercent: -4,
        ease: 'none',
        scrollTrigger: { trigger: root.current, scroller, start: 'top bottom', end: 'bottom top', scrub: true },
      },
    );
  });
    ...
    >
      ...
      <div className="cta-inner relative max-w-4xl mx-auto text-center">
        ...
        <h2 className="cta-el mt-8 display-xl text-5xl md:text-8xl font-medium text-white">
          {contact.titleA}
          <br />
          <span className="font-serif-i accent font-normal text-4xl md:text-7xl">{contact.titleB}</span>
        </h2>
