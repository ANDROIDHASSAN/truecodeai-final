...
/** The bench — 50 engineers across six divisions, with scroll-fired counters. */
export default function Team() {
  ...
  useReveal(root, (scroller) => {
    ...
    // animate a number element from 0 → its target
    ...
    // run `fire` when `selector` scrolls in — or immediately if it's
    // already on screen (e.g. the user jumped here via the nav)
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="font-display font-semibold text-4xl md:text-5xl accent tabular-nums">
                  <span className="div-num" data-value={d.count}>
                    00
                  </span>
                </div>
              </div>
